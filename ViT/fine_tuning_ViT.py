...
parser.add_argument("--output_prefix", type=str, default="vit-food101")
...
output_dir = f"{args_custom.output_prefix}-headlr{args_custom.head_lr}-baselr{args_custom.base_lr}-epoch{args_custom.num_train_epochs}"
