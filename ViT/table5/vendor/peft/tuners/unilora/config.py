...
class UniLoRAConfig(PeftConfig):
    ...
    Args:
        ...
        bias (`str`):
            Bias type for VBLoRA. Can be 'none', 'all' or 'unilora_only'. If 'all' or 'unilora_only', the corresponding
    ...
    unilora_dropout: float = field(default=0.0, metadata={"help": "VBLoRA dropout"})
    fan_in_fan_out: bool = field(
        default=False,
        metadata={"help": "Set this to True if the layer to replace stores weight like (fan_in, fan_out)"},
    )
    bias: str = field(default="none", metadata={"help": "Bias type for VBLoRA. Can be 'none', 'all' or 'unilora_only'"})
