...
class RobertaModel(RobertaPreTrainedModel):
    ...
    def __init__(self, config, add_pooling_layer=True):
        ...
        self.vector_bank = nn.Parameter(
            torch.empty(config.vector_length)
        )
        ...
        for module in self.modules():
            if isinstance(module, UniLinear):
                ...
                index_ls.append(module.project_params_A)
    ...
    def init_UniLinear_weight(self):
        for module in self.modules():
            if isinstance(module, UniLinear):
                module.init_weight()
