...
class PeftType(str, enum.Enum):
    ...
    VBLORA = "VBLORA"
    UNILORA = "UNILORA"
    UNILORA_AROMA = "UNILORA_AROMA"
    UNILORA_SKETCH_TUNE = "UNILORA_SKETCH_TUNE"
    UNILORA_SKETCH_DELTA = "UNILORA_SKETCH_DELTA"
    UNILORA_SHARED_SKETCH_BANK = "UNILORA_SHARED_SKETCH_BANK"
    UNILORA_SKETCH_ROUTED = "UNILORA_SKETCH_ROUTED"
    UNILORA_COUNT_SKETCH = "UNILORA_COUNT_SKETCH"
    UNILORA_SIGN = "UNILORA_SIGN"
    UNILORA_NONORM = "UNILORA_NONORM"
    UNILORA_FASTFOOD = "UNILORA_FASTFOOD"
    UNILORA_LEARNABLE = "UNILORA_LEARNABLE"
    UNILORA_LEARNABLE_COLUMN = "UNILORA_LEARNABLE_COLUMN"
    UNILORA_ISOMETRIC_CONTROL = "UNILORA_ISOMETRIC_CONTROL"
    UNILORA_GS = "UNILORA_GS"
    UNILORA_SOFT_ASSIGN = "UNILORA_SOFT_ASSIGN"
    UNILORA_SOFT_WEIGHT_SHARING = "UNILORA_SOFT_WEIGHT_SHARING"
    UNILORA_SWAP = "UNILORA_SWAP"
    UNILORA_LOCAL_SWAP = "UNILORA_LOCAL_SWAP"
    UNILORA_GORA = "UNILORA_GORA"
    UNILORA_GELORA = "UNILORA_GELORA"
    UNILORA_DEEPK = "UNILORA_DEEPK"
    UNILORA_BLOCK_ROUTING = "UNILORA_BLOCK_ROUTING"
    UNILORA_STAGE_RATIO = "UNILORA_STAGE_RATIO"
    UNILORA_TRAJECTORY_INITIAL = "UNILORA_TRAJECTORY_INITIAL"
    UNILORA_HESSIAN_AWARE = "UNILORA_HESSIAN_AWARE"
    UNILORA_ROSA = "UNILORA_ROSA"
    UNILORA_ROSA_SNIP = "UNILORA_ROSA_SNIP"
    UNILORA_ROSA_STAGE = "UNILORA_ROSA_STAGE"
    UNILORA_ROSA_STAGE_SNIP = "UNILORA_ROSA_STAGE_SNIP"
    UNILORA_ROSA_DISCRETE = "UNILORA_ROSA_DISCRETE"
    UNILORA_ROSA_GLOBAL = "UNILORA_ROSA_GLOBAL"
    UNILORA_ROSA_COMPRESSION = "UNILORA_ROSA_COMPRESSION"
    UNILORA_MULTI_HASHING = "UNILORA_MULTI_HASHING"
    UNILORA_MULTI_STRUCTURED = "UNILORA_MULTI_STRUCTURED"
    UNILORA_MULTI_STRUCTURED_GLOBAL = "UNILORA_MULTI_STRUCTURED_GLOBAL"
    DIRECT_UNILORA = "DIRECT_UNILORA"
    CPT = "CPT"
    BONE = "BONE"
    MISS = "MISS"
    RANDLORA = "RANDLORA"
    ...
    DELORA = "DELORA"
    GRALORA = "GRALORA"
    UNILORA_LAYER_WISE = "UNILORA_LAYER_WISE"
    UNILORA_LEARNABLE_LAYER = "UNILORA_LEARNABLE_LAYER"
    GEO_UNILORA = "GEO_UNILORA"
    IGU_UNILORA = "IGU_UNILORA"
    UNILORA_IGU = "UNILORA_IGU"
