...
@dataclass
class UniLoRALearnableConfig(PeftConfig):
    """
    This is the configuration class to store the configuration of a [`UniLoRALearnableConfig`].
    ...
    def __post_init__(self):
        self.peft_type = PeftType.UNILORA_LEARNABLE
        self.target_modules = (
