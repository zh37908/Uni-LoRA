...
@dataclass
class UniLoRANonormConfig(PeftConfig):
    """
    This is the configuration class to store the configuration of a [`UniLoRANonormConfig`].
    ...
    def __post_init__(self):
        self.peft_type = PeftType.UNILORA_NONORM
        self.target_modules = (
