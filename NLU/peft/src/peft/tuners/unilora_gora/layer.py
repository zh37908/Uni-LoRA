...
class UniLoRAGoRALayer(BaseTunerLayer):
    ...
    def __init__(self, base_layer: nn.Module, **kwargs):
        ...
        if isinstance(base_layer, nn.Linear):
            ...
            raise ValueError(f"Unsupported base layer type {type(base_layer)} for UniLoRA-GoRA.")
...
class Linear(nn.Linear, UniLoRAGoRALayer):
    def __init__(
        self,
        base_layer,
        unilora_theta_d,
        ...
        **kwargs,
        ...
        UniLoRAGoRALayer.__init__(self, base_layer, **kwargs)
