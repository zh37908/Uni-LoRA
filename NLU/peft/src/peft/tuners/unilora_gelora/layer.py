...
class UniLoRAGeLoRALayer(BaseTunerLayer):
    ...
    def __init__(self, base_layer: nn.Module, **kwargs):
        ...
        if isinstance(base_layer, nn.Linear):
            ...
            raise ValueError(f"Unsupported base layer type {type(base_layer)} for UniLoRA-GeLoRA.")
...
class Linear(nn.Linear, UniLoRAGeLoRALayer):
    def __init__(
        self,
        base_layer,
        unilora_theta_d,
        ...
        **kwargs,
        ...
        UniLoRAGeLoRALayer.__init__(self, base_layer, **kwargs)
    ...
    def forward(self, x: torch.Tensor, *args, **kwargs) -> torch.Tensor:
        ...
        if self.disable_adapters:
            ...
            for active_adapter in self.active_adapters:
                ...
                x_cast = x.to(self.unilora_theta_d[active_adapter].dtype)
