...
class UniLoRALayerWiseConfig(PeftConfig):
    ...
    theta_d_length: int = field(default=256, metadata={"help": "Total trainable intrinsic vector length d (will be split across layers)."})
    ...
    def __post_init__(self):
        self.peft_type = PeftType.UNILORA_LAYER_WISE
