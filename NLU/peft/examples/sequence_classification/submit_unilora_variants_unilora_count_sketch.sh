#!/bin/bash
#SBATCH --job-name=unilora_count_sketch_glue
#SBATCH --nodes=1
...
#SBATCH --output=results_glue_variants/unilora_count_sketch_%j.out
#SBATCH --error=results_glue_variants/unilora_count_sketch_%j.err
