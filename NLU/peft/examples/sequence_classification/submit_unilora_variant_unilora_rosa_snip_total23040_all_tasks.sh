#!/bin/bash
#SBATCH --job-name=unilora_rosa_snip_tp23040_all
#SBATCH --nodes=1
...
#SBATCH --output=logs/unilora_rosa_snip_total23040_all_%j.out
#SBATCH --error=logs/unilora_rosa_snip_total23040_all_%j.err
...
OUT_ROOT="${OUT_ROOT:-results_glue_variants_unilora_rosa_snip_total23040_all_tasks}"
mkdir -p "${OUT_ROOT}"
...
echo ">>> Generated ${TOTAL_RUNS} UniLoRA-RoSA-SNIP all-task jobs."
...
rm -f "${CMD_LIST}"
echo "All total-budget UniLoRA-RoSA-SNIP all-task jobs have been processed."
