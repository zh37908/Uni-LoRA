#!/bin/bash
#SBATCH --job-name=unilora_rosa_tp23040_all
#SBATCH --nodes=1
...
#SBATCH --output=logs/unilora_rosa_total23040_all_%j.out
#SBATCH --error=logs/unilora_rosa_total23040_all_%j.err
...
TASKS=(${TASKS:-cola mrpc qnli rte sst2})
...
OUT_ROOT="${OUT_ROOT:-results_glue_variants_unilora_rosa_total23040_all_tasks}"
mkdir -p "${OUT_ROOT}"
...
echo ">>> Generated ${TOTAL_RUNS} UniLoRA-RoSA all-task jobs."
...
rm -f "${CMD_LIST}"
echo "All total-budget UniLoRA-RoSA all-task jobs have been processed."
