...
# These sparse budgets are chosen from the previously promising compression budgets.
SPARSE_BUDGET_LIST=(${SPARSE_BUDGET_LIST:-2880 1440})

# Focus on the strongest region first, but extend the old warmup sweep.
ROSA_WARMUP_STEPS_LIST=(${ROSA_WARMUP_STEPS_LIST:-64 256 })
ROSA_MASK_STEPS_LIST=(${ROSA_MASK_STEPS_LIST:-1 8 16 })
