...
#SBATCH --output=results_glue_variants_history/unilora_variants_%j.out
#SBATCH --error=results_glue_variants_history/unilora_variants_%j.err
...
OUT_ROOT=results_glue_variants_history
mkdir -p "${OUT_ROOT}"
