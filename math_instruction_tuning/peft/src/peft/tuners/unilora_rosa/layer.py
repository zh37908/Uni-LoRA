...
class UniLoRARoSALayer(BaseTunerLayer):
    ...
    def set_sparse_active(self, adapter_name: str, active: bool) -> None:
        ...
        with torch.no_grad():
            ...
            selected_A = sparse_mask[offsets_A]
            flat_indices_A = selected_A.nonzero(as_tuple=False).flatten()
            ...
            selected_B = sparse_mask[offsets_B]
            flat_indices_B = selected_B.nonzero(as_tuple=False).flatten()
