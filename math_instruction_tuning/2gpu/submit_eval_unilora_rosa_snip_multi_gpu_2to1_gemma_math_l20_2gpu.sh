#!/bin/bash
#SBATCH --job-name=unilora_rosa_snip_mgpu_2to1_gemma_eval_2l20
#SBATCH --nodes=1
...
#SBATCH --output=logs/unilora_rosa_snip_mgpu_2to1_gemma_eval_2l20_%j.out
#SBATCH --error=logs/unilora_rosa_snip_mgpu_2to1_gemma_eval_2l20_%j.err
...
echo ">>> Starting UniLoRA-RoSA-SNIP multi-gpu 2:1 Gemma math evaluation on 2 L20 GPUs"
...
echo "UniLoRA-RoSA-SNIP multi-gpu 2:1 Gemma math evaluation finished."
