#!/bin/bash
#SBATCH --job-name=unilora_math_mistral_2l20
#SBATCH --nodes=1
...
#SBATCH --output=logs/unilora_math_mistral_2l20_%j.out
#SBATCH --error=logs/unilora_math_mistral_2l20_%j.err
...
echo ">>> Starting UniLoRA Mistral math instruction tuning on 2 L20 GPUs"
...
echo "UniLoRA Mistral math instruction tuning finished."
