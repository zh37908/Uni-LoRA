#!/bin/bash
#SBATCH --job-name=unilora_rosa_snip_mgpu_2to1_mistral_eval_2l20
#SBATCH --nodes=1
...
#SBATCH --output=logs/unilora_rosa_snip_mgpu_2to1_mistral_eval_2l20_%j.out
#SBATCH --error=logs/unilora_rosa_snip_mgpu_2to1_mistral_eval_2l20_%j.err
...
DEFAULT_ADAPTER_PATH="output/unilora_rosa_snip_multi_gpu_2to1_mistral/mistralai/Mistral-7B-v0.1/meta-math/MetaMathQA_split_train[:100000]/unilora_rosa_snip_multi_gpu_td_349525_sb_174763_w_128_m_1_rank_4_lr_0.0002_seed_42/output_2026-05-25T01:26:13-334799/ft"

BASE_MODEL="${BASE_MODEL:-mistralai/Mistral-7B-v0.1}"
ADAPTER_PATH="${ADAPTER_PATH:-${DEFAULT_ADAPTER_PATH}}"
MERGED_PATH="${MERGED_PATH:-output_merged/mistral-7b_unilora_rosa_snip_multi_gpu_2to1_metamath_td349525_sb174763_rank4_seed42}"
...
echo ">>> Starting UniLoRA-RoSA-SNIP multi-gpu 2:1 Mistral math evaluation on 2 L20 GPUs"
...
echo "UniLoRA-RoSA-SNIP multi-gpu 2:1 Mistral math evaluation finished."
