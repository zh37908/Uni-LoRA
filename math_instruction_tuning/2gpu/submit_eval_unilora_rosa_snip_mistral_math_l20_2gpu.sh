#!/bin/bash
#SBATCH --job-name=unilora_rosa_snip_mistral_eval_2l20
#SBATCH --nodes=1
...
#SBATCH --output=logs/unilora_rosa_snip_mistral_eval_2l20_%j.out
#SBATCH --error=logs/unilora_rosa_snip_mistral_eval_2l20_%j.err
...
DEFAULT_ADAPTER_PATH="output/mistralai/Mistral-7B-v0.1/meta-math/MetaMathQA_split_train[:100000]/unilora_rosa_snip_td_507904_sb_16384_w_128_m_1_rank_4_lr_0.0002_seed_42/output_2026-05-22T11:07:53-558060/ft"

BASE_MODEL="${BASE_MODEL:-mistralai/Mistral-7B-v0.1}"
ADAPTER_PATH="${ADAPTER_PATH:-${DEFAULT_ADAPTER_PATH}}"
MERGED_PATH="${MERGED_PATH:-output_merged/mistral-7b_unilora_rosa_snip_metamath_td507904_sb16384_rank4_seed42}"
...
echo ">>> Starting UniLoRA-RoSA-SNIP Mistral math evaluation on 2 L20 GPUs"
...
echo "UniLoRA-RoSA-SNIP Mistral math evaluation finished."
